 ...
 * @author pedro.costa
 */
public class Formulario_Produtos_consulta extends javax.swing.JFrame {

    /**
     * Creates new form Formulario_produtos
     */
    Produtos produto = new Produtos();
    public Formulario_Produtos_consulta() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String idText = JOptionPane.showInputDialog("Digite o id que deseja alterar:");
        int id = Integer.parseInt(idText);
        
        produto.updateProduto(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Formulario_Produtos_consulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Formulario_Produtos_consulta().setVisible(true);
            }
        });
    }
